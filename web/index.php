...
<!--注意修改此处-->
<?php
if ( isset($_POST['pass']) & isset($_POST['name']) & @MD5($_POST['pass'])=="1*****1" & @$_POST['name']=="xxx" )
{
?>
<body bgcolor="#110f13">

<iframe id="frm1" name="frm"src="http://127.0.0.1:57575/" width="677" height="593" scrolling="yes" frameborder="0"></iframe>
<iframe id="frm2" name="frm"src="includeme.php" width="557" height="593" scrolling="no" frameborder="0"></iframe>
<!--注意修改以上-->
<?php
}else{
?>
